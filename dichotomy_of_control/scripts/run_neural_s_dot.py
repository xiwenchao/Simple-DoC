...
from dichotomy_of_control.models.sdoc_decision_transformer import StochasticDecisionTransformer
...
flags.DEFINE_float('prior_weight', 0., 'Unused for SDOT; kept for compatibility.')
flags.DEFINE_float('energy_weight', 0., 'Unused for SDOT; kept for compatibility.')
